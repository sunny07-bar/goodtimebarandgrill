...
export default function MenuClient({ categories, items }: MenuClientProps) {
  ...
  // Effect to sync with URL query param
  useEffect(() => {
        ...
        <div className="mb-10 md:mb-14 flex justify-center">
          <div className="inline-flex bg-[#111111] border-2 border-white/10 rounded-2xl p-2 gap-2 shadow-2xl">
            <button
              ...
              className={`flex items-center gap-3 px-8 md:px-10 py-4 md:py-5 rounded-xl font-semibold min-h-[52px] relative overflow-hidden ${selectedType === 'food'
            ...
            <button
              ...
              className={`flex items-center gap-3 px-8 md:px-10 py-4 md:py-5 rounded-xl font-semibold min-h-[52px] relative overflow-hidden ${selectedType === 'drink'
                  ? 'bg-gradient-to-r from-[#fbbf24] to-[#f59e0b] text-black shadow-lg shadow-[#F59E0B]/35 scale-105'
                  : 'text-[#D1D5DB] hover:text-[#F59E0B]'
                }`}
            >
            ...
            >
              {filteredCategories.map((category) => (
                <button
                  ...
                  className={`relative whitespace-nowrap text-sm md:text-base px-6 md:px-8 py-3 md:py-4 rounded-xl font-semibold min-h-[44px] flex-shrink-0 ${selectedCategoryId === category.id
