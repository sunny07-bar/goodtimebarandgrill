      ...
      <div className="container-global">
              ...
              {aboutSection?.body ? (
                ...
                <div className="body-text text-sm md:text-base lg:text-lg leading-relaxed space-y-3 md:space-y-4 text-[#D1D5DB]">
                  <p className="text-base md:text-lg lg:text-xl leading-relaxed text-white/90 font-light mb-3 md:mb-4">
                    ...
                    {locationInfo.address && ` We are located at ${locationInfo.address} and are open daily for happy hour, and dinner.`}
                  </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8 mb-12 md:mb-16 lg:mb-20">
          <div className="card-premium text-center group hover:border-[#F59E0B]/50 p-4 md:p-6">
            ...
            <h3 className="card-title mb-2 md:mb-3 text-[#F59E0B] text-base md:text-lg">PASSION</h3>
          ...
          <div className="card-premium text-center group hover:border-[#F59E0B]/50 p-4 md:p-6">
            ...
            <h3 className="card-title mb-2 md:mb-3 text-[#F59E0B] text-base md:text-lg">COMMUNITY</h3>
            <p className="body-text text-xs md:text-sm">
          ...
          <div className="card-premium text-center group hover:border-[#F59E0B]/50 p-4 md:p-6">
            ...
            <h3 className="card-title mb-2 md:mb-3 text-[#F59E0B] text-base md:text-lg">QUALITY</h3>
            <p className="body-text text-xs md:text-sm">
          ...
          <div className="card-premium text-center group hover:border-[#F59E0B]/50 p-4 md:p-6">
            ...
            <h3 className="card-title mb-2 md:mb-3 text-[#F59E0B] text-base md:text-lg">EXPERIENCE</h3>
            <p className="body-text text-xs md:text-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 lg:gap-8">
          <div className="card-premium">
            <h2 className="card-title mb-4 md:mb-6 text-[#F59E0B] text-lg md:text-xl">LOCATION</h2>
            <div className="space-y-4 md:space-y-5">
              <div>
                <p className="font-semibold body-text mb-2 text-sm md:text-base">Address</p>
                <p className="body-text opacity-80 text-sm md:text-base">{locationInfo.address}</p>
              </div>
              <div>
                <p className="font-semibold body-text mb-2 text-sm md:text-base">Phone</p>
                <a href={`tel:${locationInfo.phone.replace(/\D/g, '')}`} className="price-amber hover:text-[#D97706] transition-colors text-sm md:text-base">
                  {locationInfo.phone}
                </a>
              </div>
              <div>
                <p className="font-semibold body-text mb-2 text-sm md:text-base">Email</p>
                <a href={`mailto:${locationInfo.email}`} className="price-amber hover:text-[#D97706] transition-colors text-sm md:text-base break-all">
                  {locationInfo.email}
                </a>
              </div>
            </div>
          ...
          <div className="card-premium">
            <h2 className="card-title mb-4 md:mb-6 text-[#F59E0B] text-lg md:text-xl">OPENING HOURS</h2>
            <div className="space-y-3 md:space-y-4">
              {(() => {
                ...
                return dayNames.map((dayName, index) => {
                  ...
                  return (
                    <div key={index} className="flex justify-between items-center pb-2 md:pb-3 border-b border-white/10 last:border-b-0">
                      <span className="font-medium body-text text-sm md:text-base">{dayName}</span>
                      <span className="body-text opacity-60 text-sm md:text-base">Closed</span>
                    </div>
                  )
                }
                return (
