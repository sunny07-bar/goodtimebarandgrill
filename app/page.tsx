import { getBanners, getFeaturedMenuItems, getUpcomingEvents, getGalleryImages, getHomeFeatures, getAllSiteSettings, getOpeningHours } from '@/lib/queries'
...
export default async function Home() {
  const [banners, featuredItems, upcomingEvents, galleryImages, partiesImages, homeFeatures, siteSettings, openingHours] = await Promise.all([
    getBanners(),
